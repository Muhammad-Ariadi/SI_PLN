          ...
          if ("table" != this.nodeName.toLowerCase()) W(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
            ...
            var f,
              ...
              g =
                ...
                null !== r.iDeferLoading && ((h.bDeferLoading = !0), (t = Array.isArray(r.iDeferLoading)), (h._iRecordsDisplay = t ? r.iDeferLoading[0] : r.iDeferLoading), (h._iRecordsTotal = t ? r.iDeferLoading[1] : r.iDeferLoading)),
                h.oLanguage),
              t =
                  ...
                  .each(function (t, e) {
                    ...
                    a || W(h, 0, "Incorrect column count", 18),
                      a.mData === t &&
                        ...
                        (null === n && null === e) ||
                          ((a.mData = { _: t + ".display", sort: null !== n ? t + ".@data-" + n : H, type: null !== n ? t + ".@data-" + n : H, filter: null !== e ? t + ".@data-" + e : H }), (a._isArrayHost = !0), at(h, t)));
                  }));
            var S = h.oFeatures,
              t = function () {
                if (r.aaSorting === H) {
  ...
  function Qt(n) {
    ...
    n.scrollBarVis !== R && n.scrollBarVis !== H
      ...
      : ((n.scrollBarVis = R),
        ...
        (f = D.outerWidth()),
        "" === s ? ((w.width = "100%"), x && (D.find("tbody").height() > g.offsetHeight || "scroll" == b.css("overflow-y")) && (w.width = M(D.outerWidth() - l)), (f = D.outerWidth())) : "" !== u && ((w.width = M(u)), (f = D.outerWidth())),
        k(t, e),
        k(function (t) {
  ...
  function ee(t) {
    ...
    if (g || (!h && !l && !i && s == T(t) && s == c.length))
      ...
      for (b.find("thead, tfoot").remove(), b.append(P(t.nTHead).clone()).append(P(t.nTFoot).clone()), b.find("tfoot th, tfoot td").css("width", ""), c = Ct(t, b.find("thead")[0]), _ = 0; _ < u.length; _++)
        (e = r[u[_]]), (c[_].style.width = null !== e.sWidthOrig && "" !== e.sWidthOrig ? M(e.sWidthOrig) : ""), e.sWidthOrig && l && P(c[_]).append(P("<div/>").css({ width: e.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
        ...
        var e = this,
          t = this.iterator("column", function (t, e) {
            ...
            if (e === H) i.bVisible;
              ...
              if (e) for (var s = P.inArray(!0, N(o, "bVisible"), r + 1), u = 0, c = l.length; u < c; u++) (a = l[u].nTr), (n = l[u].anCells), a && a.insertBefore(n[r], n[s] || null);
