                                    ...
                                    <div class="card-body pt-0 mt-0">
                                        <form class="myForm" action="pelangganproses2.php?proses=prosestambah" method="post" enctype="multipart/form-data" autocomplete="off" required>
                                            ...
                                            <div class="input-group input-group-outline my-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="idpel" class="form-control" placeholder="Masukkan ID Pelanggan Minimal 11 Angka dan Maksimal 12 Angka" autofocus minlength="11" maxlength="12" required>
                                            ...
                                            <div class="input-group input-group-outline my-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="nama_pel" class="form-control" placeholder="Masukkan Nama Pelanggan" required minlength="2" maxlength="50">
                                            ...
                                            <div class="input-group input-group-outline my-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="alamat" class="form-control" placeholder="Masukkan Type kWh Meter" require>
                                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                                </div>
                                            </div>
                                            <div class="input-group input-group-outline my-3">
