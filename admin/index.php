...
if (isset($_SESSION['username'])) {
    ...
    if ($level == '0') {
        ...
        $queryTarget4 = $db->query("SELECT COUNT(*) as jumlah_target4 FROM tbl_pelanggan");
        $dataTarget4 = $queryTarget4->fetch_assoc();
        $jumlah_target4 = $dataTarget4['jumlah_target4'];
                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                ...
                                <h4 class="mb-0"><?php echo $jumlah_target4; ?></h4>
                            </div>
                        </div>
