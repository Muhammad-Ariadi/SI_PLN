...
if (isset($_GET['proses']) && $_GET['proses'] == 'prosestambah') {
    ...
    $idpel_target = $_POST['idpel_target'];
    ...
    $query = "INSERT INTO tbl_target (tanggal,tanggal_akhir, idpel_target,kd_akun,nama_pel,rbm,tipe,alamat,latitude, longitude,status) 
          VALUES ('$tanggal','$tanggal_akhir', '$idpel_target','$kd_akun','$nama_pel', '$rbm','$tipe','$alamat','$latitude', '$longitude' , '$status')";
    ...
    $query = "SELECT kd_akun FROM tbl_target WHERE idpel_target='$idpel_target'";
