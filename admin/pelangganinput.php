            ...
            <div class="col-12">
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class=" -flex justify-content-between mb-3 bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        <th class="text-uppercase text-secondary  font-weight-bolder ">Idpel</th>
                                        <th class="text-uppercase text-secondary  font-weight-bolder ps-2">Nama</th>
                                        <th class="text-center text-uppercase text-secondary  font-weight-bolder ">Daya</th>
                                        <th class="text-center text-uppercase text-secondary  font-weight-bolder ">Tipe</th>
                                        <th class="text-center text-uppercase text-secondary  font-weight-bolder ">Lokasi</th>
                                        <th class="text-center text-uppercase text-secondary  font-weight-bolder ">Pmet</th>
                                        <th class="text-center text-uppercase text-secondary  font-weight-bolder ">Merek</th>
                                        <th class="text-center text-uppercase text-secondary  font-weight-bolder ">tipe meter</th>
                                        <th class="text-center text-uppercase text-secondary  font-weight-bolder ">Nomer Meter</th>
                                        <th class="text-center text-uppercase text-secondary  font-weight-bolder ">Keterangan</th>
                                        <th class="text-center text-uppercase text-secondary  font-weight-bolder ">Rincian</th>
                                        <th class="text-center text-uppercase text-secondary  font-weight-bolder ">Opsi</th>
